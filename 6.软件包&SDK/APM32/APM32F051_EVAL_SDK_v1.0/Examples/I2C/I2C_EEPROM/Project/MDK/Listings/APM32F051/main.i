...
uint8_t txDataBufI2C[(255)] = {0};
uint8_t rxDataBufI2C[(255)] = {0};
...
void I2C_EE_Test(void)
{
    ...
    errSta = I2C_EE_BufferWrite(txDataBufI2C, 0x00, (255));
    
    if(errSta == I2C_EE_OK)
    {
        printf("Write data: \r\n");
        Buffer_Print(txDataBufI2C, (255));
        
         
        errSta = I2C_EE_BufferRead(rxDataBufI2C, 0x00, (255));
        
        if(errSta == I2C_EE_OK)
        {
            printf("\r\nRead data: \r\n");
            Buffer_Print(rxDataBufI2C, (255));
        }
        else
        {
    ...
    if (Buffer_Compare(txDataBufI2C, rxDataBufI2C, (255)) == TRUE)
    {
    ...
    else
    {
        APM_EVAL_LEDOff(LED2);
        APM_EVAL_LEDOn(LED3);
        LCD_DisplayString(10,110,menuItemStr[2],((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),24,0);
