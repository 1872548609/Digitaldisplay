#line 1 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_key.c"
...
#line 28 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_key.c"
#line 29 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_key.c"
...
uint8_t Key_Scan(uint8_t mode)
{
    ...
    if(s_keyRelease && (GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_6) == 0 || GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_7) == 0 || GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_8) == 0 || GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_9) == 0))
    {
        APM_EVAL_DelayMs(10);

        s_keyRelease = 0;

        if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_6) == 0)
        {
            return KEY1_PRESSED;
        }
        else if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_7) == 0)
        {
            return KEY2_PRESSED;
        }
        else if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_8) == 0)
        {
            return KEY3_PRESSED;
        }
        else if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_9) == 0)
        {
            return KEY4_PRESSED;
        }
    }
    else if(GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_6) == 1 && GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_7) == 1 && GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_8) == 1 && GPIO_ReadInputBit(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)),GPIO_PIN_9) == 1)
    {
        s_keyRelease = 1;
    }
