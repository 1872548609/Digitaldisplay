...
#line 32 "..\\..\\Source\\main.c"
#line 1 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\inc\\bsp_key.h"
...
#line 31 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\inc\\bsp_key.h"
...
void USART1_Init(uint32_t baud)
{
    ...
    GPIO_ConfigPinAF(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_SOURCE_9,GPIO_AF_PIN1);

     
    GPIO_ConfigPinAF(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)),GPIO_PIN_SOURCE_10,GPIO_AF_PIN1);
    ...
    GPIO_Config(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)), &gpioConfigStruct);
    ...
    USART_Config(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)), &usartConfigStruct);

     
    USART_EnableInterrupt(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)),USART_INT_RXBNEIE);

    NVIC_EnableIRQRequest(USART1_IRQn,2);

     
    USART_Enable(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)));
}
...
void USART_INT_Test(void)
{
    LCD_DisplayString(10,110,menuItemStr[3],((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),24,0);
    APM_EVAL_LEDOff(LED2);
    APM_EVAL_LEDOff(LED3);
    
    USART_Write(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)),(uint8_t*)"Hello APM EVAL Board\r\n");
    
    LCD_DisplayString(10,110,menuItemStr[1],((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),24,0);
}
...
void USART_Receive_Isr(void)
{
    ...
    if(USART_ReadStatusFlag(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)), USART_FLAG_RXBNE) == SET)
    {
        dat = (uint8_t)USART_RxData(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)));
...
void USART_Send_Isr(void)
{
    while(USART_ReadStatusFlag(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)),USART_FLAG_TXBE)==RESET);

    if(USART_ReadStatusFlag(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)),USART_FLAG_TXC))
    {
         
        printf("Send Finish\r\n");

        USART_ClearStatusFlag(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)),USART_FLAG_TXC);
    }
}
...
void APM_EVAL_Init(void)
{
    ...
    APM_LCDInit();
    LCD_Clear(0,0,320,240,((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)));
...
void Menu_DisplayInit(void)
{
    ...
    LCD_Clear(0,0,320,40,((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)));
    LCD_DisplayString(10,10,menuTitleStr[0],((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),24,0);
    
     
    LCD_DisplayString(10,110,menuItemStr[0],((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),24,0);
    
     
    LCD_Clear(0,220,320,240,((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)));
    LCD_DisplayString(60,220,menuBottomColStr[0],((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),16,0);
}
...
void APM_EVAL_TMR14_Init(uint16_t period, uint16_t div)
{
    ...
    TMR_ConfigTimeBase(((TMR_T*) (((uint32_t)0x40000000) + 0x00002000)),&timeBaseConfig);

     
    TMR_EnableInterrupt(((TMR_T*) (((uint32_t)0x40000000) + 0x00002000)),TMR_INT_UPDATE);
    NVIC_EnableIRQRequest(TMR14_IRQn,2);

     
    TMR_Enable(((TMR_T*) (((uint32_t)0x40000000) + 0x00002000)));
}
...
void TMR14_Isr(void)
{
    if(TMR_ReadIntFlag(((TMR_T*) (((uint32_t)0x40000000) + 0x00002000)),TMR_INT_FLAG_UPDATE) == SET)
    {
        TMR_ClearIntFlag(((TMR_T*) (((uint32_t)0x40000000) + 0x00002000)),TMR_INT_FLAG_UPDATE);
        cntTick++;
...
int fputc(int ch, FILE* f)
{
    ...
    USART_TxData(((USART_T*) (((uint32_t)0x40000000) + 0x00013800)), (uint8_t)ch);
