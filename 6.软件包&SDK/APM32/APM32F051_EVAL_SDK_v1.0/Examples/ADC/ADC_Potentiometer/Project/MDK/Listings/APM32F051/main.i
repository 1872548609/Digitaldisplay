...
void Potentiometer_Test(void)
{
    ...
    LCD_Clear(0,110,320,134,((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)));
    
    printf("\r\nTest start \r\n");
    
    while(1)
    {
        LCD_DisplayIntNum(128,110,voltage,4,((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),24);
        LCD_DisplayString(180,110,"mV",((((0) & 0xF8) << 8) | (((222) & 0xFC) << 3) | (((152) & 0xF8) >> 3)),((((255) & 0xF8) << 8) | (((255) & 0xFC) << 3) | (((255) & 0xF8) >> 3)),24,0);
        APM_EVAL_DelayMs(50);
    }
}
