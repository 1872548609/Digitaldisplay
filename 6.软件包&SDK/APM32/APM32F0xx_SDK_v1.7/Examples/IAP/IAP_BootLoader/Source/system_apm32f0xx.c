...
/** @defgroup IAP_BootLoader_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group IAP_BootLoader_System_Enumerations */

/** @defgroup IAP_BootLoader_System_Structures System_Structures
  @{
  */

/**@} end of group IAP_BootLoader_System_Structures */
