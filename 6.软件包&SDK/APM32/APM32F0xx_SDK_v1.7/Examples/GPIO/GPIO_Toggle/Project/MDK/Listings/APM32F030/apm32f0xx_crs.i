#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_crs.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_crs.h"
...
#line 38 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_crs.h"
...
typedef enum
{
    CRS_INT_SYNCOK    = ((uint32_t)0x00000001),   
    CRS_INT_SYNCWARN  = ((uint32_t)0x00000002),   
    CRS_INT_ERR       = ((uint32_t)0x00000004),   
    CRS_INT_ESYNC     = ((uint32_t)0x00000008),   
    CRS_INT_SYNCERR   = ((uint32_t)0x00000100),   
    CRS_INT_SYNCMISS  = ((uint32_t)0x00000200),   
    CRS_INT_TRIMOVF   = ((uint32_t)0x00000400),   
} CRS_INT_T;
...
typedef enum
{
    CRS_FLAG_SYNCOK    = ((uint32_t)0x00000001),   
    CRS_FLAG_SYNCWARN  = ((uint32_t)0x00000002),   
    CRS_FLAG_ERR       = ((uint32_t)0x00000004),   
    CRS_FLAG_ESYNC     = ((uint32_t)0x00000008),   
    CRS_FLAG_SYNCERR   = ((uint32_t)0x00000100),   
    CRS_FLAG_SYNCMISS  = ((uint32_t)0x00000200),   
    CRS_FLAG_TRIMOVF   = ((uint32_t)0x00000400),   
} CRS_FLAG_T;
...
typedef enum
{
    CRS_SYNC_SOURCE_GPIO =  0x00,  
    CRS_SYNC_SOURCE_LSE  =  0x01,  
    CRS_SYNC_SOURCE_USB  =  0x02,  
} CRS_SYNC_SOURCE_T;
...
#line 30 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_crs.c"
...
#line 31 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_crs.c"
...
void CRS_AdjustHSI48CalibrationValue(uint8_t calibrationVal)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.HSI48TRM = calibrationVal;
}
...
void CRS_EnableFrequencyErrorCounter(void)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.CNTEN = SET;
}
...
void CRS_DisableFrequencyErrorCounter(void)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.CNTEN = RESET;
}
...
void CRS_EnableAutomaticCalibration(void)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.AUTOTRMEN = SET;
}
...
void CRS_DisableAutomaticCalibration(void)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.AUTOTRMEN = RESET;
}
...
void CRS_GenerateSoftwareSynchronization(void)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.SWSGNR = SET;
}
...
void CRS_FrequencyErrorCounterReloadValue(uint16_t reloadVal)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CFG_B.RLDVAL = reloadVal;
}
...
void CRS_ConfigFrequencyErrorLimit(uint8_t errLimitVal)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CFG_B.FELMT = errLimitVal;
}
...
void CRS_ConfigSynchronizationPrescaler(CRS_SYNC_DIV_T div)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CFG_B.SYNCPSC = div;
}
...
void CRS_ConfigSynchronizationSource(CRS_SYNC_SOURCE_T source)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CFG_B.SYNCSRCSEL = source;
}
...
void CRS_ConfigSynchronizationPolarity(CRS_SYNC_POL_T polarity)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CFG_B.SYNCPOLSEL = polarity;
}
...
uint32_t CRS_ReadReloadValue(void)
{
    return (uint32_t)((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CFG_B.RLDVAL;
}
...
uint32_t CRS_ReadHSI48CalibrationValue(void)
{
    return (uint32_t)((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL_B.HSI48TRM;
}
...
uint32_t CRS_ReadFrequencyErrorValue(void)
{
    return (uint32_t)((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTSTS_B.FECPT;
}
...
uint32_t CRS_ReadFrequencyErrorDirection(void)
{
    return (uint32_t)((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTSTS_B.CNTDRCT;
}
...
void CRS_EnableInterrupt(CRS_INT_T interrupt)
{
    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->CTRL |= interrupt;
}
...
{
    uint32_t status;
    status = (uint32_t)(((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTSTS & flag);
...
void CRS_ClearStatusFlag(CRS_FLAG_T flag)
{
    ...
    {
        ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTCLR_B.ECLR = BIT_SET;
    }

    ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTCLR |= (uint32_t)flag;
}
...
uint8_t CRS_ReadIntFlag(CRS_INT_T flag)
{
    if ((((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTSTS & flag))
    {
        return SET;
    }
    else
...
void CRS_ClearIntFlag(CRS_INT_T intFlag)
{
    ...
    {
        ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTCLR |= CRS_INT_ERR;
    }
    else
    {
        ((CRS_T*) (((uint32_t)0x40000000) + 0x00006C00))->INTCLR |= intFlag;
    }
}
