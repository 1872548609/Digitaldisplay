#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_can.c"
...
#line 5485 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"

#line 5500 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"

#line 5515 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"
...
#line 5528 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"
...
#line 5566 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"

#line 5581 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"

#line 5588 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"

#line 5598 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"
...
#line 5638 "..\\..\\..\\..\\..\\Libraries\\Device\\Geehy\\APM32F0xx\\Include\\apm32f0xx.h"
...
#line 28 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_can.c"
...
#line 29 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_can.c"
...
uint8_t CAN_Config(CAN_Config_T* canConfig)
{
    ...
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.SLEEPREQ = BIT_RESET;

    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.INITREQ = BIT_SET;

    while ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.INITFLG != BIT_SET) && (ackWait != (uint32_t)0x00FFFFFF))
    {
        ackWait++;
    }

    if (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.INITFLG != BIT_SET)
    {
        InitStatus = RESET;
    }
    else
    {
        ...
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.TTCM = BIT_SET;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.TTCM = BIT_RESET;
        }

        if (canConfig->autoBusOffManage == ENABLE)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.ALBOFFM = BIT_SET;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.ALBOFFM = BIT_RESET;
        }

        if (canConfig->autoWakeUpMode == ENABLE)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.AWUPCFG = BIT_SET;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.AWUPCFG = BIT_RESET;
        }

        if (canConfig->nonAutoRetran == ENABLE)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.ARTXMD = BIT_SET;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.ARTXMD = BIT_RESET;
        }

        if (canConfig->rxFIFOLockMode == ENABLE)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.RXFLOCK = BIT_SET;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.RXFLOCK = BIT_RESET;
        }

        if (canConfig->txFIFOPriority == ENABLE)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.TXFPCFG = BIT_SET;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.TXFPCFG = BIT_RESET;
        }

        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->BITTIM = (uint32_t)canConfig->mode << 30;
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->BITTIM_B.RSYNJW     = canConfig->syncJumpWidth;
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->BITTIM_B.TIMSEG1 = canConfig->timeSegment1;
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->BITTIM_B.TIMSEG2 = canConfig->timeSegment2;
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->BITTIM_B.BRPSC     = canConfig->prescaler - 1;

        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.INITREQ = BIT_RESET;
        ...
        if (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.INITFLG == BIT_RESET)
        {
            InitStatus = SET;
        }
        else
...
void CAN_ConfigFilter(CAN_FilterConfig_T* filterConfig)
{
    ...
    filterNumber = 0x00000001 << filterConfig->filterNumber;

    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FCTRL_B.FIM = BIT_SET;

    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FACT &= ~filterNumber;

    if (filterConfig->filterScale == CAN_FILTER_SCALE_16BIT)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FSCFG &= ~filterNumber;

        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sFilterRegister[filterConfig->filterNumber].R1 =
            ((0x0000FFFF & filterConfig->filterMaskIdLow) << 16) |
            (0x0000FFFF & filterConfig->filterIdLow);

        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sFilterRegister[filterConfig->filterNumber].R2 =
    ...
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FMCFG &= ~filterNumber;
    }
    else
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FMCFG |= filterNumber;
    ...
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FFASS &= ~filterNumber;
    }
    else
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FFASS |= filterNumber;
    ...
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FCTRL_B.FIM = BIT_RESET;
}
...
void CAN_StartBankSlave(uint8_t bankNumber)
{
    ...
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FCTRL &= 0xFFFFC0F1;
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->FCTRL |= (uint32_t)(bankNumber) << 8;
...
void CAN_EnableDebugFreeze(void)
{
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.DBGFRZE = BIT_SET;
}
...
void CAN_DisableDebugFreeze(void)
{
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.DBGFRZE = BIT_RESET;
}
...
void CAN_EnableTTComMode(void)
{
    ...
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[0].TXDLEN_B.TXGT = BIT_SET;
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[1].TXDLEN_B.TXGT = BIT_SET;
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[2].TXDLEN_B.TXGT = BIT_SET;
}
...
void CAN_DisableTTComMode(void)
{
    ...
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[0].TXDLEN_B.TXGT = BIT_RESET;
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[1].TXDLEN_B.TXGT = BIT_RESET;
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[2].TXDLEN_B.TXGT = BIT_RESET;
}
...
uint8_t CAN_TxMessage(CAN_Tx_Message* TxMessage)
{
    ...
    if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG0 == BIT_SET))
    {
        TxMailbox = 0;
    }
    else if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG1 == BIT_SET))
    {
        TxMailbox = 1;
    }
    else if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG2 == BIT_SET))
    {
        TxMailbox = 2;
    }
    else
    ...
    if (TxMailbox != CAN_TX_MAILBOX_FULL)
    {
        ...
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMID &= 0x00000001;
        if (TxMessage->typeID == CAN_TYPEID_STD)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMID |= (((uint32_t)TxMessage->stanID << 21) |                                                  TxMessage->typeID        |                                                  TxMessage->remoteTxReq);


        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMID |= (((uint32_t)TxMessage->extenID << 3) |                                                  TxMessage->typeID       |                                                  TxMessage->remoteTxReq);


        }

         
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXDLEN_B.DLCODE = (TxMessage->dataLengthCode & 0x0F);

         
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDH_B.DATABYTE7 = TxMessage->data[7];
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDH_B.DATABYTE6 = TxMessage->data[6];
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDH_B.DATABYTE5 = TxMessage->data[5];
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDH_B.DATABYTE4 = TxMessage->data[4];

        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDL_B.DATABYTE3 = TxMessage->data[3];
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDL_B.DATABYTE2 = TxMessage->data[2];
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDL_B.DATABYTE1 = TxMessage->data[1];
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sTxMailBox[TxMailbox].TXMDL_B.DATABYTE0 = TxMessage->data[0];
...
uint8_t CAN_TxMessageStatus(CAN_MAILBOX_T TxMailbox)
{
    ...
    {
        case (CAN_MAILBOX_0):
            if (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG0 && ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXSUSFLG0 && ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG0)
            {
                state = CAN_TX_OK;
            }
            else if (!(((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG0 || ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXSUSFLG0 || ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG0))
            {
        ...
        case (CAN_MAILBOX_1):
            if (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG1 && ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXSUSFLG1 && ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG1)
            {
                state = CAN_TX_OK;
            }
            else if (!(((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG1 || ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXSUSFLG1 || ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG1))
            {
                state = CAN_TX_WAITING;
            }
            break;
        ...
        case (CAN_MAILBOX_2):
            if (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG2 && ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXSUSFLG2 && ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG2)
            {
                state = CAN_TX_OK;
            }
            else if (!(((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG2 || ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXSUSFLG2 || ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.TXMEFLG2))
            {
                state = CAN_TX_WAITING;
            }
            break;
...
void CAN_CancelTx(CAN_MAILBOX_T TxMailbox)
{
    ...
    {
        case 0:
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.ABREQFLG0 = BIT_SET;
            break;

        case 1:
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.ABREQFLG1 = BIT_SET;
            break;

        case 2:
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.ABREQFLG2 = BIT_SET;
            break;
...
void CAN_RxMessage(uint8_t FIFONumber, CAN_Rx_Message* RxMessage)
{
    RxMessage->typeID = (CAN_TYPEID_T)(0x00000004 & ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMID);

    if (RxMessage->typeID == CAN_TYPEID_STD)
    {
        RxMessage->stanID = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMID_B.STDID;
    }
    else
    {
        RxMessage->extenID = (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMID_B.STDID << 18);
        RxMessage->extenID |= ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMID_B.EXTID;
    }

    RxMessage->remoteTxReq = (CAN_RTXR_T)(0x00000002 & ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMID);
    RxMessage->dataLengthCode = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXDLEN_B.DLCODE;
    RxMessage->filterMatchIndex = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXDLEN_B.FMIDX;

    RxMessage->data[7] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDH_B.DATABYTE7;
    RxMessage->data[6] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDH_B.DATABYTE6;
    RxMessage->data[5] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDH_B.DATABYTE5;
    RxMessage->data[4] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDH_B.DATABYTE4;

    RxMessage->data[3] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDL_B.DATABYTE3;
    RxMessage->data[2] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDL_B.DATABYTE2;
    RxMessage->data[1] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDL_B.DATABYTE1;
    RxMessage->data[0] = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->sRxFIFO[FIFONumber].RXMDL_B.DATABYTE0;

    if (FIFONumber == CAN_FIFO_0)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.RFOM0 = BIT_SET;
    }
    else
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.RFOM1 = BIT_SET;
    }
}
...
uint8_t CAN_PendingMessage(uint8_t FIFONumber)
{
    if (FIFONumber == CAN_FIFO_0)
    {
        return  ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.FMNUM0;
    }
    else
    {
        return  ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.FMNUM1;
    }
}
...
uint8_t CAN_OperatingMode(CAN_OPERATING_MODE_T operatingMode)
{
    ...
    sleepflg = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.SLEEPFLG;
    initfig = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.INITFLG;
    ...
    switch ((uint8_t)operatingMode)
    {
        ...
        case CAN_OPERATING_MODE_SLEEP:
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.INITREQ = BIT_RESET;
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MCTRL_B.SLEEPREQ     = BIT_SET;
...
uint8_t CAN_SleepMode(void)
{
    ...
    if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.SLEEPFLG == BIT_SET) && (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.INITFLG == BIT_RESET))
    {
...
uint8_t CAN_WakeUpMode(void)
{
    ...
    while ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.SLEEPFLG == BIT_SET) && (slakWait != 0x00))
    {
        slakWait--;
    }
    if (((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.SLEEPFLG != BIT_SET)
    {
...
{
    uint8_t errorcode = 0;
    errorcode = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.LERRC;
    return errorcode;
}
...
{
    uint8_t counter = 0;
    counter = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.RXERRCNT;
    return counter;
}
...
{
    uint8_t counter = 0;
    counter = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.TXERRCNT;
    return counter;
}
...
void CAN_EnableInterrupt(uint32_t interrupt)
{
    ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->INTEN |= interrupt;
}
...
uint8_t CAN_ReadStatusFlag(CAN_FLAG_T flag)
{
    ...
    {
        if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS & (flag & 0x000FFFFF)) != (uint32_t)RESET)
        {
            status = SET;
        }
        else
    ...
    {
        if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS & (flag & 0x000FFFFF)) != (uint32_t)RESET)
        {
            status = SET;
        }
        else
    ...
    {
        if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS & (flag & 0x000FFFFF)) != (uint32_t)RESET)
        {
            status = SET;
        }
        else
    ...
    {
        if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0 & (flag & 0x000FFFFF)) != (uint32_t)RESET)
        {
            status = SET;
        }
        else
    ...
    {
        if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1 & (flag & 0x000FFFFF)) != (uint32_t)RESET)
        {
            status = SET;
        }
        else
...
void CAN_ClearStatusFlag(CAN_FLAG_T flag)
{
    ...
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.LERRC = 0;
    }
    else
    {
        ...
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS = flagtmp;
        }
        else if ((flag & 0x02000000) != RESET)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS = flagtmp;
        }
        else if ((flag & 0x04000000) != RESET)
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0 = flagtmp;
        }
        else
        {
            ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1 = flagtmp;
        }
    }
}
...
uint8_t CAN_ReadIntFlag(CAN_INT_T interrupt)
{
    ...
    if ((((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->INTEN & interrupt) != RESET)
    {
        switch (interrupt)
        {
            case CAN_INT_TXME:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG0;
                status |= ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG1;
                status |= ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG2;
                break;
            case CAN_INT_F0MP:
                status = !(!((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.FMNUM0);
                break;
            case CAN_INT_F0FUL:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.FFULLFLG0;
                break;
            case CAN_INT_F0OVR:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.FOVRFLG0;
                break;
            case CAN_INT_F1MP:
                status = !(!((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.FMNUM1);
                break;
            case CAN_INT_F1FUL:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.FFULLFLG1;
                break;
            case CAN_INT_F1OVR:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.FOVRFLG1;
                break;
            case CAN_INT_EWIE:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.ERRWFLG;
                break;
            case CAN_INT_EPIE:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.ERRPFLG;
                break;
            case CAN_INT_BOIE:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.BOFLG;
                break;
            case CAN_INT_LEC:
                status = !(!((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->ERRSTS_B.LERRC);
                break;
            case CAN_INT_ERR:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.ERRIFLG;
                break;
            case CAN_INT_WUP:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.WUPIFLG;
                break;
            case CAN_INT_SLE:
                status = ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.SLEEPIFLG;
                break;
            default:
                status = RESET;
                break;
...
void CAN_ClearIntFlag(uint32_t interrupt)
{
    ...
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG0 = BIT_SET;
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG1 = BIT_SET;
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->TXSTS_B.REQCFLG2 = BIT_SET;
    }
    if (interrupt & CAN_INT_F0FUL)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.FFULLFLG0 = BIT_SET;
    }
    if (interrupt & CAN_INT_F0OVR)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF0_B.FOVRFLG0 = BIT_SET;
    }
    if (interrupt & CAN_INT_F1FUL)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.FFULLFLG1 = BIT_SET;
    }
    if (interrupt & CAN_INT_F1OVR)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->RXF1_B.FOVRFLG1 = BIT_SET;
    }
    if (interrupt & CAN_INT_EWIE)
    {
        ...
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.ERRIFLG = BIT_SET;
    }
    ...
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.WUPIFLG = BIT_SET;
    }
    if (interrupt & CAN_INT_SLE)
    {
        ((CAN_T*) (((uint32_t)0x40000000) + 0x00006400))->MSTS_B.SLEEPIFLG = BIT_SET;
    }
}
