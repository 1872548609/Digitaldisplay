...
extern u16  ADC_Start(u8 channel);
extern u8   Temper_Conver(u8 channel);
extern u8   Press_Conver(u8 channel);
extern void ADMotorCheck(void);
//===============================
//DEFINITIONs
//===============================
#define d_ADCnEN0           0x17
...
#define LOWTEMP_CRITICAL 3990//-1度
#define ADC_TABLE_SIZE      201
#define PRESSURE_TABLE_SIZE 26 
