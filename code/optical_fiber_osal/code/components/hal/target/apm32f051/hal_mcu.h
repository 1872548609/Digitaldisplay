 ...
 * ------------------------------------------------------------------------------------------------
 */
#define HAL_ENABLE_INTERRUPTS()         st( __set_PRIMASK(0);/*打开全部中断*/ )
#define HAL_DISABLE_INTERRUPTS()        st( __set_PRIMASK(1);/*关闭全部中断*/ )
#define HAL_INTERRUPTS_ARE_ENABLED()    (EA)

typedef unsigned char halIntState_t;
#define HAL_ENTER_CRITICAL_SECTION(x)   st( x = 0;	__set_PRIMASK(1);/*关闭全部中断*/ )
#define HAL_EXIT_CRITICAL_SECTION(x)    st(  	 	__set_PRIMASK(x);/*打开全部中断*/ )
