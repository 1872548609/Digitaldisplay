 ...
 * ------------------------------------------------------------------------------------------------
 */
#define HAL_ENABLE_INTERRUPTS()         st( __set_PRIMASK(0);/*´ò¿ªÈ«²¿ÖÐ¶Ï*/ )
#define HAL_DISABLE_INTERRUPTS()        st( __set_PRIMASK(1);/*¹Ø±ÕÈ«²¿ÖÐ¶Ï*/ )
#define HAL_INTERRUPTS_ARE_ENABLED()    (EA)

typedef unsigned char halIntState_t;
#define HAL_ENTER_CRITICAL_SECTION(x)   st( x = 0; __set_PRIMASK(1);/*¹Ø±ÕÈ«²¿ÖÐ¶Ï*/ )
#define HAL_EXIT_CRITICAL_SECTION(x)    st(  						__set_PRIMASK(x);/*´ò¿ªÈ«²¿ÖÐ¶Ï*/ )
