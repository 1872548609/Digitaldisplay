#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_syscfg.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_syscfg.h"
...
#line 34 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_syscfg.h"
...
typedef enum
{
    ...
    SYSCFG_PORT_GPIOE   = ((uint8_t)0x04),    
...
typedef enum
{
    ...
    SYSCFG_DAM_REMAP_TMR16_2   = ((uint32_t)0x00002000),    
    SYSCFG_DAM_REMAP_TMR17_2   = ((uint32_t)0x00004000),    
    SYSCFG_DAM_REMAP_SPI2      = ((uint32_t)0x01000000),    
    SYSCFG_DAM_REMAP_USART2    = ((uint32_t)0x02000000),    
    SYSCFG_DAM_REMAP_USART3    = ((uint32_t)0x04000000),    
    SYSCFG_DAM_REMAP_I2C1      = ((uint32_t)0x08000000),    
    SYSCFG_DAM_REMAP_TMR1      = ((uint32_t)0x10000000),    
    SYSCFG_DAM_REMAP_TMR2      = ((uint32_t)0x20000000),    
    SYSCFG_DAM_REMAP_TMR3      = ((uint32_t)0x40000000),    
} SYSCFG_DAM_REMAP_T;
...
typedef enum
{
    ...
    SYSCFG_I2C_FMP_I2C2      = ((uint32_t)0x00200000),      
...
typedef enum
{
    ...
    SYSCFG_LOCK_PVD        = ((uint32_t)0x00000004),        
} SYSCFG_LOCK_T;
...
typedef enum
{
    SYSCFG_IRDA_ENV_TMR16      = ((uint32_t)0x000000C0),    
    SYSCFG_IRDA_ENV_USART1     = ((uint32_t)0x00000040),    
    SYSCFG_IRDA_ENV_USART4     = ((uint32_t)0x00000080),    
} SYSCFG_IRDA_ENV_T;
...
#line 27 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_syscfg.c"
...
void SYSCFG_SelectIRDAEnv(SYSCFG_IRDA_ENV_T IRDAEnv)
{
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG1 &= ~(0x000000C0);
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG1 |= (IRDAEnv);
}
...
void SYSCFG_BreakLock(uint32_t lock)
{
    ...
    ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2_B.PVDLOCK = 0;
    ...
    {
        ((SYSCFG_T*) (((uint32_t)0x40000000) + 0x00010000))->CFG2_B.PVDLOCK = BIT_SET;
    }
}
