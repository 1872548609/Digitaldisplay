#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_rtc.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_rtc.h"
...
#line 34 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_rtc.h"
...
#line 350 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_rtc.h"

#line 358 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_rtc.h"
...
#line 28 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_rtc.c"
...
#line 29 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_rtc.c"
...
uint8_t RTC_Reset(void)
{
    ...
    else
    {
        ...
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->AUTORLD  = (uint32_t)0x0000FFFF;
...
#line 669 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_rtc.c"
    }
    else
    {
...
#line 679 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_rtc.c"
    }
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.WUCLKSEL = wakeUpClock;
    RTC_EnableWriteProtection();
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->AUTORLD = wakeUpValue;
    RTC_EnableWriteProtection();
}
...
uint32_t RTC_ReadWakeUpValue(void)
{
    return ((uint32_t)(((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->AUTORLD & 0x0000FFFF));
}
...
{
    RTC_DisableWriteProtection();
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.WUTEN = BIT_SET;
    RTC_EnableWriteProtection();
}
...
uint8_t RTC_DisableWakeUp(void)
{
    ...
    ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->CTRL_B.WUTEN = BIT_RESET;

    while ((count != ((uint32_t) 0x00004000)) && ((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.WUTWFLG) == BIT_RESET))
    {
        count++;
    }

    if ((((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.WUTWFLG) == BIT_RESET)
    {
        RTC_EnableWriteProtection();
        return ERROR;
    }
...
void RTC_ConfigTamperTrigger(RTC_TAMPER_T tamper, RTC_TAMPER_TRIGGER_T trigger)
{
    if (trigger == RTC_TAMPER_TRIGGER_RISINGEDGE)
    {
        ...
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP3ALCFG = BIT_RESET;
        }
    }
    else
    {
        ...
        if (tamper == RTC_TAMPER_3)
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP3ALCFG = BIT_SET;
        }
    }
}
...
void RTC_EnableTamper(RTC_TAMPER_T tamper)
{
    ...
    if (tamper == RTC_TAMPER_3)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP3EN = BIT_SET;
    }
...
void RTC_DisableTamper(RTC_TAMPER_T tamper)
{
    ...
    if (tamper == RTC_TAMPER_3)
    {
        ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->TACFG_B.TP3EN = BIT_RESET;
    }
}
...
uint8_t RTC_ConfigSynchroShift(RTC_SHIFT_ADD1S_T add1S, uint32_t subFS)
{
    ...
    if (((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->STS_B.SOPFLG == BIT_RESET)
    {
        ...
        {
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->SHIFT_B.ADD1SECEN = add1S;
            ((RTC_T*) (((uint32_t)0x40000000) + 0x00002800))->SHIFT_B.SFSEC = subFS;
