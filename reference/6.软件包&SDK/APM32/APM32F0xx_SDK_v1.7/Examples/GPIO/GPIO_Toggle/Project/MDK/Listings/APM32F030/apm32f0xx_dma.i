#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_dma.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_dma.h"
...
#line 36 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_dma.h"
...
typedef enum
{
    ...
    DMA1_FLAG_AL6    = ((uint32_t)0x00100000),   
    DMA1_FLAG_TF6    = ((uint32_t)0x00200000),   
    DMA1_FLAG_HT6    = ((uint32_t)0x00400000),   
    DMA1_FLAG_TE6    = ((uint32_t)0x00800000),   
     
    DMA1_FLAG_AL7    = ((uint32_t)0x01000000),   
    DMA1_FLAG_TF7    = ((uint32_t)0x02000000),   
    DMA1_FLAG_HT7    = ((uint32_t)0x04000000),   
    DMA1_FLAG_TE7    = ((uint32_t)0x08000000),   
     
    DMA2_FLAG_AL1    = ((uint32_t)0x10000001),   
    DMA2_FLAG_TF1    = ((uint32_t)0X00000002),   
    DMA2_FLAG_HT1    = ((uint32_t)0X00000004),   
    DMA2_FLAG_TE1    = ((uint32_t)0X00000008),   
     
    DMA2_FLAG_AL2    = ((uint32_t)0x10000010),   
    DMA2_FLAG_TF2    = ((uint32_t)0x10000020),   
    DMA2_FLAG_HT2    = ((uint32_t)0x10000040),   
    DMA2_FLAG_TE2    = ((uint32_t)0x10000080),   
     
    DMA2_FLAG_AL3    = ((uint32_t)0x10000100),   
    DMA2_FLAG_TF3    = ((uint32_t)0x10000200),   
    DMA2_FLAG_HT3    = ((uint32_t)0x10000400),   
    DMA2_FLAG_TE3    = ((uint32_t)0x10000800),   
     
    DMA2_FLAG_AL4    = ((uint32_t)0x10001000),   
    DMA2_FLAG_TF4    = ((uint32_t)0x10002000),   
    DMA2_FLAG_HT4    = ((uint32_t)0x10004000),   
    DMA2_FLAG_TE4    = ((uint32_t)0x10008000),   
     
    DMA2_FLAG_AL5    = ((uint32_t)0x10010000),   
    DMA2_FLAG_TF5    = ((uint32_t)0x10020000),   
    DMA2_FLAG_HT5    = ((uint32_t)0x10040000),   
    DMA2_FLAG_TE5    = ((uint32_t)0x10080000),   
} DMA_FLAG_T;
...
typedef enum
{
    ...
    DMA1_INT_FLAG_AL6 = ((uint32_t)0x00100000),   
    DMA1_INT_FLAG_TF6 = ((uint32_t)0x00200000),   
    DMA1_INT_FLAG_HT6 = ((uint32_t)0x00400000),   
    DMA1_INT_FLAG_TE6 = ((uint32_t)0x00800000),   
     
    DMA1_INT_FLAG_AL7 = ((uint32_t)0x01000000),   
    DMA1_INT_FLAG_TF7 = ((uint32_t)0x02000000),   
    DMA1_INT_FLAG_HT7 = ((uint32_t)0x04000000),   
    DMA1_INT_FLAG_TE7 = ((uint32_t)0x08000000),   
     
    DMA2_INT_FLAG_AL1 = ((uint32_t)0x10000001),   
    DMA2_INT_FLAG_TF1 = ((uint32_t)0x10000002),   
    DMA2_INT_FLAG_HT1 = ((uint32_t)0x10000004),   
    DMA2_INT_FLAG_TE1 = ((uint32_t)0x10000008),   
     
    DMA2_INT_FLAG_AL2 = ((uint32_t)0x10000010),   
    DMA2_INT_FLAG_TF2 = ((uint32_t)0x10000020),   
    DMA2_INT_FLAG_HT2 = ((uint32_t)0x10000040),   
    DMA2_INT_FLAG_TE2 = ((uint32_t)0x10000080),   
     
    DMA2_INT_FLAG_AL3 = ((uint32_t)0x10000100),   
    DMA2_INT_FLAG_TF3 = ((uint32_t)0x10000200),   
    DMA2_INT_FLAG_HT3 = ((uint32_t)0x10000400),   
    DMA2_INT_FLAG_TE3 = ((uint32_t)0x10000800),   
     
    DMA2_INT_FLAG_AL4 = ((uint32_t)0x10001000),   
    DMA2_INT_FLAG_TF4 = ((uint32_t)0x10002000),   
    DMA2_INT_FLAG_HT4 = ((uint32_t)0x10004000),   
    DMA2_INT_FLAG_TE4 = ((uint32_t)0x10008000),   
     
    DMA2_INT_FLAG_AL5 = ((uint32_t)0x10010000),   
    DMA2_INT_FLAG_TF5 = ((uint32_t)0x10020000),   
    DMA2_INT_FLAG_HT5 = ((uint32_t)0x10040000),   
    DMA2_INT_FLAG_TE5 = ((uint32_t)0x10080000),   
} DMA_INT_FLAG_T;
...
#line 28 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_dma.c"
...
void DMA_Reset(DMA_CHANNEL_T* channel)
{
    ...
    else if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x0000006C)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x00F00000;
    }
    else if (channel == ((DMA_CHANNEL_T*) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000080)))
    {
        ((DMA_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->INTFCLR = (uint32_t)0x0F000000;
    }
    else if (channel == ((DMA_CHANNEL_T *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000400) + 0x00000008)))
    {
        ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTFCLR = (uint32_t)0x0000000F;
    }
    else if (channel == ((DMA_CHANNEL_T *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000400) + 0x0000001C)))
    {
        ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTFCLR = (uint32_t)0x000000F0;
    }
    else if (channel == ((DMA_CHANNEL_T *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000400) + 0x00000030)))
    {
        ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTFCLR = (uint32_t)0x00000F00;
    }
    else if (channel == ((DMA_CHANNEL_T *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000400) + 0x00000044)))
    {
        ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTFCLR = (uint32_t)0x0000F000;
    }
    else if (channel == ((DMA_CHANNEL_T *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000400) + 0x00000058)))
    {
        ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTFCLR = (uint32_t)0x000F0000;
    }
}
...
uint8_t DMA_ReadStatusFlag(DMA_FLAG_T flag)
{
    ...
    {
        status = ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTSTS & ((uint32_t)flag & 0x000FFFFF);
    }
    else
    {
...
void DMA_ClearStatusFlag(uint32_t flag)
{
    if ((flag & 0x10000000) == SET)
    {
        ((DMA_T *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000400))->INTFCLR |= (uint32_t)(flag & 0x000FFFFF);
    }
    else
    {
