#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_dac.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_dac.h"
...
#line 38 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_dac.h"
...
#line 59 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_dac.h"
...
typedef enum
{
    DAC_TRIGGER_NONE     = ((uint32_t)0x00000000),       
    DAC_TRIGGER_T2_TRGO  = ((uint32_t)0x00000024),       
    DAC_TRIGGER_T3_TRGO  = ((uint32_t)0x0000000C),       
    DAC_TRIGGER_T6_TRGO  = ((uint32_t)0x00000004),       
    DAC_TRIGGER_T7_TRGO  = ((uint32_t)0x00000014),       
    DAC_TRIGGER_T15_TRGO = ((uint32_t)0x0000001C),       
    DAC_TRIGGER_EINT_IT9 = ((uint32_t)0x00000034),       
    DAC_TRIGGER_SOFTWARE = ((uint32_t)0x0000003C)        
} DAC_TRIGGER_T;
...
typedef enum
{
    DAC_WAVE_GENERATION_NONE     = ((uint32_t)0x00000000),       
    DAC_WAVE_GENERATION_NOISE    = ((uint32_t)0x00000040),       
    DAC_WAVE_GENERATION_TRIANGLE = ((uint32_t)0x00000080)        
...
typedef enum
{
    DAC_LFSRUNAMASK_BIT0        = ((uint32_t)0x00000000),        
    DAC_LFSRUNAMASK_BITS1_0     = ((uint32_t)0x00000100),        
    DAC_LFSRUNAMASK_BITS2_0     = ((uint32_t)0x00000200),        
    DAC_LFSRUNAMASK_BITS3_0     = ((uint32_t)0x00000300),        
    DAC_LFSRUNAMASK_BITS4_0     = ((uint32_t)0x00000400),        
    DAC_LFSRUNAMASK_BITS5_0     = ((uint32_t)0x00000500),        
    DAC_LFSRUNAMASK_BITS6_0     = ((uint32_t)0x00000600),        
    DAC_LFSRUNAMASK_BITS7_0     = ((uint32_t)0x00000700),        
    DAC_LFSRUNAMASK_BITS8_0     = ((uint32_t)0x00000800),        
    DAC_LFSRUNAMASK_BITS9_0     = ((uint32_t)0x00000900),        
    DAC_LFSRUNAMASK_BITS10_0    = ((uint32_t)0x00000A00),        
    DAC_LFSRUNAMASK_BITS11_0    = ((uint32_t)0x00000B00),        
    DAC_TRIANGLEAMPLITUDE_1     = ((uint32_t)0x00000000),        
    DAC_TRIANGLEAMPLITUDE_3     = ((uint32_t)0x00000100),        
    DAC_TRIANGLEAMPLITUDE_7     = ((uint32_t)0x00000200),        
    DAC_TRIANGLEAMPLITUDE_15    = ((uint32_t)0x00000300),        
    DAC_TRIANGLEAMPLITUDE_31    = ((uint32_t)0x00000400),        
    DAC_TRIANGLEAMPLITUDE_63    = ((uint32_t)0x00000500),        
    DAC_TRIANGLEAMPLITUDE_127   = ((uint32_t)0x00000600),        
    DAC_TRIANGLEAMPLITUDE_255   = ((uint32_t)0x00000700),        
    DAC_TRIANGLEAMPLITUDE_511   = ((uint32_t)0x00000800),        
    DAC_TRIANGLEAMPLITUDE_1023  = ((uint32_t)0x00000900),        
    DAC_TRIANGLEAMPLITUDE_2047  = ((uint32_t)0x00000A00),        
    DAC_TRIANGLEAMPLITUDE_4095  = ((uint32_t)0x00000B00)         
...
typedef enum
{
    DAC_OUTPUTBUFF_ENABLE  = ((uint32_t)0x00000000),  
    DAC_OUTPUTBUFF_DISABLE = ((uint32_t)0x00000002)   
} DAC_OUTPUTBUFF_T;
...
typedef enum
{
    DAC_CHANNEL_1  = ((uint32_t)0x00000000),     
    DAC_CHANNEL_2  = ((uint32_t)0x00000010)      
} DAC_CHANNEL_T;
...
typedef enum
{
    DAC_ALIGN_12B_R = ((uint32_t)0x00000000),    
    DAC_ALIGN_12B_L = ((uint32_t)0x00000004),    
    DAC_ALIGN_8B_R  = ((uint32_t)0x00000008)     
} DAC_DATA_ALIGN_T;
...
typedef enum
{
    DAC_INT_CH1_DMAUDR = ((uint32_t)0x00002000),     
    DAC_INT_CH2_DMAUDR = ((uint32_t)0x20000000)      
} DAC_INT_T;
...
typedef enum
{
    DAC_FLAG_CH1_DMAUDR = ((uint32_t)0x00002000),      
    DAC_FLAG_CH2_DMAUDR = ((uint32_t)0x20000000)       
} DAC_FLAG_T;
...
#line 30 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_dac.c"
...
#line 31 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_dac.c"
...
void DAC_Config(uint32_t channel, DAC_Config_T* dacConfig)
{
    ...
    tmpcfg = ((uint32_t)dacConfig->trigger |               (uint32_t)dacConfig->waveGeneration |               (uint32_t)dacConfig->maskAmplitudeSelect |               (uint32_t)dacConfig->outputBuff);



    ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL = (tmpcfg << channel);
}
...
void DAC_Enable(DAC_CHANNEL_T channel)
{
    ...
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.ENCH1 = SET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.ENCH2 = SET;
    }
}
...
void DAC_Disable(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.ENCH1 = RESET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.ENCH2 = RESET;
    }
}
...
void DAC_EnableSoftwareTrigger(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->SWTRG_B.SWTRG1 = SET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->SWTRG_B.SWTRG2 = SET;
    }
}
...
void DAC_DisableSoftwareTrigger(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->SWTRG_B.SWTRG1 = RESET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->SWTRG_B.SWTRG2 = RESET;
    }
}
...
void DAC_EnableDualSoftwareTrigger(void)
{
    ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->SWTRG |= ((uint32_t)0x00000003);
}
...
void DAC_DisableDualSoftwareTrigger(void)
{
    ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->SWTRG &= ((uint32_t)0xFFFFFFFC);
}
...
void DAC_EnableWaveGeneration(DAC_CHANNEL_T channel, DAC_WAVE_GENERATION_T wave)
{
    ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL |= ((uint32_t)wave) << ((uint32_t)channel);
}
...
void DAC_ConfigChannel1Data(DAC_DATA_ALIGN_T dataAlign, uint16_t data)
{
    ...
    tmp = (uint32_t)(((uint32_t)0x40000000) + 0x00007400);
    tmp += ((uint32_t)0x00000008) + dataAlign;
...
void DAC_ConfigChannel2Data(DAC_DATA_ALIGN_T dataAlign, uint16_t data)
{
    volatile uint32_t tmp = 0;
    tmp = (uint32_t)(((uint32_t)0x40000000) + 0x00007400);
    tmp += ((uint32_t)0x00000014) + dataAlign;
    *(volatile uint32_t*)tmp = data;
}
...
void DAC_ConfigDualChannelData(DAC_DATA_ALIGN_T dataAlign, uint16_t data2, uint16_t data1)
{
    ...
    tmp = (uint32_t)(((uint32_t)0x40000000) + 0x00007400);
    tmp += ((uint32_t)0x00000020) + dataAlign;
    *(volatile uint32_t*)tmp = data;
}
...
uint16_t DAC_ReadDataOutputValue(DAC_CHANNEL_T channel)
{
    ...
    if (channel == DAC_CHANNEL_1)
    {
        data = ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->DATAOCH1_B.DATA;
    }
    else
    {
        data = ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->DATAOCH2_B.DATA;
    }
    return data;
}
...
void DAC_EnableDMA(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAENCH1 = SET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAENCH2 = SET;
    }
}
...
void DAC_DisableDMA(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAENCH1 = RESET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAENCH2 = RESET;
    }
}
...
void DAC_EnableInterrupt(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAUDRIEN1 = SET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAUDRIEN2 = SET;
    }
}
...
void DAC_DisableInterrupt(DAC_CHANNEL_T channel)
{
    if (channel == DAC_CHANNEL_1)
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAUDRIEN1 = RESET;
    }
    else
    {
        ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL_B.DMAUDRIEN2 = RESET;
    }
}
...
uint8_t DAC_ReadStatusFlag(DAC_FLAG_T flag)
{
    ...
    status = (uint16_t)(((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->STS & flag);
    if (status == flag)
    {
        return SET;
    }
...
void DAC_ClearStatusFlag(DAC_FLAG_T flag)
{
    ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->STS &= (uint32_t)~flag;
}
...
{
    uint32_t intEnable;
    intEnable = (((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->CTRL & intFlag);
    if (((((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->STS & intFlag) != (uint32_t)RESET) && intEnable)
    {
        return SET;
    }
    else
...
void DAC_ClearIntFlag(DAC_INT_T intFlag)
{
    ((DAC_T*) (((uint32_t)0x40000000) + 0x00007400))->STS = intFlag;
}
