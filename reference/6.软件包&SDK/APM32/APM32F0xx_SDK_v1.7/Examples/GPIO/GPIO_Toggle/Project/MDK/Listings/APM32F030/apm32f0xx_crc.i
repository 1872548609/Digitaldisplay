#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_crc.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_crc.h"
...
#line 36 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_crc.h"
...
#line 28 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_crc.c"
...
void CRC_Reset(void)
{
    ...
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->POL = 0x04C11DB7;
}
...
void CRC_SetPolynomialSize(CRC_POLYNOMIAL_SIZE_T polynomialSize)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->CTRL_B.POLSIZE = polynomialSize;
}
...
void CRC_SetPolynomialValue(uint32_t polynomialValue)
{
    ((CRC_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->POL = polynomialValue;
}
...
uint32_t CRC_CalculateCRC16bits(uint16_t data)
{
    *(uint16_t*)(((((uint32_t)0x40000000) + 0x00020000) + 0x00003000)) = (uint16_t) data;
...
uint32_t CRC_CalculateCRC8bits(uint8_t data)
{
    *(uint8_t*)(((((uint32_t)0x40000000) + 0x00020000) + 0x00003000)) = (uint8_t) data;
