#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_cec.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_cec.h"
...
#line 36 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_cec.h"
...
typedef enum
{
    ...
    CEC_SINGANL_FREETIME_1T       = 0x01,  
    CEC_SINGANL_FREETIME_2T       = 0x02,  
    CEC_SINGANL_FREETIME_3T       = 0x03,  
    CEC_SINGANL_FREETIME_4T       = 0x04,  
    CEC_SINGANL_FREETIME_5T       = 0x05,  
    CEC_SINGANL_FREETIME_6T       = 0x06,  
    CEC_SINGANL_FREETIME_7T       = 0x07,  
...
typedef enum
{
    CEC_RX_TOLERANCE_STANDARD  =  0x00,    
    CEC_RX_TOLERANCE_EXTENDED  =  0x01     
} CEC_RX_TOLERANCE_T;
...
typedef enum
{
    CEC_STOP_RECEPTION_OFF,            
    CEC_STOP_RECEPTION_ON              
...
typedef enum
{
    CEC_BIT_RISING_ERR_OFF,            
    CEC_BIT_RISING_ERR_ON              
...
typedef enum
{
    CEC_LONG_PERIOD_ERR_OFF,          
    CEC_LONG_PERIOD_ERR_ON            
...
typedef enum
{
    CEC_BROADCAST_NO_ERR_OFF,          
    CEC_BROADCAST_NO_ERR_ON            
...
typedef enum
{
    CEC_SIGNAL_FREETIME_OPTION_OFF,    
    CEC_SIGNAL_FREETIME_OPTION_ON      
...
typedef enum
{
    CEC_INT_RXBR   = ((uint32_t)0x00000001),  
    CEC_INT_RXEND  = ((uint32_t)0x00000002),  
    CEC_INT_RXOVR  = ((uint32_t)0x00000004),  
    CEC_INT_BRE    = ((uint32_t)0x00000008),  
    CEC_INT_SBPE   = ((uint32_t)0x00000010),  
    CEC_INT_LBPE   = ((uint32_t)0x00000020),  
    CEC_INT_RXACKE = ((uint32_t)0x00000040),  
    CEC_INT_ARBLST = ((uint32_t)0x00000080),  
    CEC_INT_TXBR   = ((uint32_t)0x00000100),  
    CEC_INT_TXEND  = ((uint32_t)0x00000200),  
    CEC_INT_TXUDR  = ((uint32_t)0x00000400),  
    CEC_INT_TXERR  = ((uint32_t)0x00000800),  
    CEC_INT_TXACKE = ((uint32_t)0x00001000),  
} CEC_INT_T;
...
typedef enum
{
    CEC_FLAG_RXBR   = ((uint32_t)0x00000001),   
    CEC_FLAG_RXEND  = ((uint32_t)0x00000002),   
    CEC_FLAG_RXOVR  = ((uint32_t)0x00000004),   
    CEC_FLAG_BRE    = ((uint32_t)0x00000008),   
    CEC_FLAG_SBPE   = ((uint32_t)0x00000010),   
    CEC_FLAG_LBPE   = ((uint32_t)0x00000020),   
    CEC_FLAG_RXACKE = ((uint32_t)0x00000040),   
    CEC_FLAG_ARBLST = ((uint32_t)0x00000080),   
    CEC_FLAG_TXBR   = ((uint32_t)0x00000100),   
    CEC_FLAG_TXEND  = ((uint32_t)0x00000200),   
    CEC_FLAG_TXUDR  = ((uint32_t)0x00000400),   
    CEC_FLAG_TXERR  = ((uint32_t)0x00000800),   
    CEC_FLAG_TXACKE = ((uint32_t)0x00001000),   
} CEC_FLAG_T;
...
typedef struct
{
    CEC_SIGNAL_FREETIME_T  signalFreeTime;      
    CEC_RX_TOLERANCE_T     RxTolerance;         
    CEC_STOP_RECEPTION_T   stopReception;       
    CEC_BIT_RISING_ERR_T   bitRisingError;      
    CEC_LONG_PERIOD_ERR_T  longPeriodError;     
    CEC_BROADCAST_NO_ERR_T broadcastrNoGen;     
    CEC_SIGNAL_FREETIME_OPTION_T signalFreeTimeOption; 
} CEC_Config_T;
...
#line 28 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_cec.c"
...
#line 29 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_cec.c"
...
void CEC_Config(CEC_Config_T* cecConfig)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.SFTCFG    = cecConfig->signalFreeTime;
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.RXTCFG   = cecConfig->RxTolerance;
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.RXSBRERR = cecConfig->stopReception;
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.GEBRERR  = cecConfig->bitRisingError;
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.GELBPERR = cecConfig->longPeriodError;
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.AEBGIB = cecConfig->broadcastrNoGen;
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.SFTOB  = cecConfig->signalFreeTimeOption;
}
...
void CEC_Enable(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CTRL_B.CECEN = SET;
}
...
void CEC_Disable(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CTRL_B.CECEN = RESET;
}
...
void CEC_EnableListenMode(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.LMODSEL = SET;
}
...
void CEC_DisableListenMode(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.LMODSEL = RESET;
}
...
void CEC_ConfigOwnAddress(uint8_t ownAddress)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG_B.OACFG |= (1 << ownAddress);
}
...
void CEC_ClearQwnAddress(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CFG = 0x00;
}
...
void CEC_TxData(uint8_t Data)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->TXDATA = Data;
}
...
uint8_t CEC_RxData(void)
{
    return (uint8_t)(((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->RXDATA);
}
...
void CEC_StartNewMessage(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CTRL_B.TXSM = SET;
}
...
void CEC_CompleteMessage(void)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->CTRL_B.TXEM = SET;
}
...
void CEC_EnableInterrupt(uint32_t interrupt)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->INTEN |= (uint32_t)interrupt;
}
...
uint8_t CEC_ReadStatusFlag(uint32_t flag)
{
    ...
    status = (uint32_t)(((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->STS & flag);
...
void CEC_ClearStatusFlag(uint32_t flag)
{
    ((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->STS = flag;
}
...
uint8_t CEC_ReadIntFlag(uint16_t flag)
{
    uint32_t intEnable;
    uint32_t intStatus;
    intEnable = (((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->INTEN & flag);
    intStatus = (((CEC_T*) (((uint32_t)0x40000000) + 0x00007800))->STS & flag);
