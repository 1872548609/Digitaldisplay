#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_comp.c"
...
#line 1 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_comp.h"
...
#line 36 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\inc\\apm32f0xx_comp.h"
...
typedef enum
{
    COMP_SELECT_COMP1 = ((uint32_t)0x00000000),   
    COMP_SELECT_COMP2 = ((uint32_t)0x00000010)    
} COMP_SELECT_T;
...
typedef enum
{
    COMP_INVERTING_INPUT_1_4VREFINT = 0x00,  
    COMP_INVERTING_INPUT_1_2VREFINT = 0x01,  
    COMP_INVERTING_INPUT_3_4VREFINT = 0x02,  
    COMP_INVERTING_INPUT_VREFINT    = 0x03,  
    COMP_INVERTING_INPUT_DAC1       = 0x04,  
    COMP_INVERTING_INPUT_DAC2       = 0x05,  
    COMP_INVERTING_INPUT_IO         = 0x06,  
...
typedef enum
{
    COMP_OUTPUT_NONE         = 0x00,  
    COMP_OUTPUT_TIM1BKIN     = 0x01,  
    COMP_OUTPUT_TIM1IC1      = 0x02,  
    COMP_OUTPUT_TIM1OCREFCLR = 0x03,  
    COMP_OUTPUT_TIM2IC4      = 0x04,  
    COMP_OUTPUT_TIM2OCREFCLR = 0x05,  
    COMP_OUTPUT_TIM3IC1      = 0x06,  
    COMP_OUTPUT_TIM3OCREFCLR = 0x07,  
} COMP_OUTPUT_T;
...
typedef enum
{
    COMP_HYSTERRSIS_NO     = 0x00,  
    COMP_HYSTERRSIS_LOW    = 0x01,  
    COMP_HYSTERRSIS_MEDIUM = 0x02,  
    COMP_HYSTERRSIS_HIGH   = 0x03,  
} COMP_HYSTERRSIS_T;
...
typedef enum
{
    COMP_MODE_HIGHSPEED    = 0x00,  
    COMP_MODE_MEDIUMSPEED  = 0x01,  
    COMP_MODE_LOWPOWER     = 0x02,  
    COMP_MODE_VERYLOW      = 0x03   
} COMP_MODE_T;
...
typedef struct
{
    COMP_INVERTING_INPUT_T invertingInput;  
    COMP_OUTPUT_T      output;              
    COMP_OUTPUTPOL_T   outputPol;           
    COMP_HYSTERRSIS_T  hysterrsis;          
    COMP_MODE_T        mode;                
} COMP_Config_T;
...
#line 28 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_comp.c"
...
#line 29 "..\\..\\..\\..\\..\\Libraries\\APM32F0xx_StdPeriphDriver\\src\\apm32f0xx_comp.c"
...
void COMP_Reset(void)
{
    ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS = ((uint32_t)0x00000000);
}
...
void COMP_Config(COMP_SELECT_T compSelect, COMP_Config_T* compConfig)
{
    ...
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.INVINSEL1 = compConfig->invertingInput;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.OUTSEL1 = compConfig->output;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.OPINV1 = compConfig->outputPol;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.HYSCFG1    = compConfig->hysterrsis;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.MOD1   = compConfig->mode;
    }
    else
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.INVINSEL2 = compConfig->invertingInput;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.OUTSEL2  = compConfig->output;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.OPINV2  = compConfig->outputPol;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.HYSCFG2 = compConfig->hysterrsis;
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.MOD2 = compConfig->mode;
    }
}
...
void COMP_Enable(COMP_SELECT_T compSelect)
{
    if (compSelect == COMP_SELECT_COMP1)
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.EN1 = SET;
    }
    else
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.EN2 = SET;
    }
}
...
void COMP_Disable(COMP_SELECT_T compSelect)
{
    if (compSelect == COMP_SELECT_COMP1)
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.EN1 = RESET;
    }
    else
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.EN2 = RESET;
    }
}
...
void COMP_EnableSwitch(void)
{
    ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.SW1 = SET;
}
...
void COMP_DisableSwitch(void)
{
    ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.SW1 = RESET;
}
...
uint32_t COMP_ReadOutPutLevel(COMP_SELECT_T compSelect)
{
    ...
    if (compSelect == COMP_SELECT_COMP1)
    {
        if ((((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS & ((uint32_t)0x00004000))  != 0)
        {
    ...
    {
        if ((((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS & ((uint32_t)0x40000000))  != 0)
        {
            compOUT = ((uint32_t)0x00004000);
        }
        else
...
void COMP_EnableWindow(void)
{
    ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.WMODEN = SET;
}
...
void COMP_DisnableWindow(void)
{
    ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.WMODEN = RESET;
}
...
void COMP_ConfigLOCK(COMP_SELECT_T compSelect)
{
    if (compSelect == COMP_SELECT_COMP1)
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.LOCK1 = SET;
    }
    else
    {
        ((COMP_T*) (((uint32_t)0x40000000) + 0x0001001C))->CSTS_B.LOCK2 = SET;
    }
}
