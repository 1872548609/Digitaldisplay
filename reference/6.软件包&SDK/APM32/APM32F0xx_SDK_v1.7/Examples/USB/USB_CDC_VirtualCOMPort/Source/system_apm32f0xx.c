...
/** @defgroup USB_CDC_VirtualCOMPort_System_Enumerations System_Enumerations
  @{
*/

/**@} end of group USB_CDC_VirtualCOMPort_System_Enumerations */

/** @defgroup USB_CDC_VirtualCOMPort_System_Structures System_Structures
  @{
*/

/**@} end of group USB_CDC_VirtualCOMPort_System_Structures */
