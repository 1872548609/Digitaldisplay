#line 1 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_i2c_ee.c"
...
#line 1 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\inc\\bsp_i2c_ee.h"
...
#line 32 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\inc\\bsp_i2c_ee.h"
...
#line 28 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_i2c_ee.c"
...
#line 29 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_i2c_ee.c"
...
#line 30 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_i2c_ee.c"
...
void APM_I2C_EE_Init(void)
{
    ...
    GPIO_ConfigPinAF(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), GPIO_PIN_SOURCE_10, GPIO_AF_PIN1);
     
    GPIO_ConfigPinAF(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), GPIO_PIN_SOURCE_11, GPIO_AF_PIN1);
    ...
    GPIO_Config(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), &gpioConfigStruct);

    gpioConfigStruct.pin = GPIO_PIN_11;
    GPIO_Config(((GPIO_T*) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)), &gpioConfigStruct);

     
    I2C_Reset(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)));
    ...
    I2C_Config(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)),&i2cConfigStruct);

     
    I2C_Enable(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)));
    
    eeI2CInfo.address = 0xA0;
...
I2C_EE_ERROR_T I2C_EE_PageWrite(uint8_t* buffer, uint16_t writeAddr, uint8_t* number)
{
    ...
    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, eeI2CInfo.addrNum, I2C_RELOAD_MODE_RELOAD, I2C_GENERATE_START_WRITE);
    
    eeI2CInfo.timeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
    while(I2C_ReadStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_TXINT) == RESET)
    {
...
#line 152 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_i2c_ee.c"

     
    I2C_TxData(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), (uint8_t)(writeAddr & 0x00FF));
    
    eeI2CInfo.timeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
    while(I2C_ReadStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_TCRF) == RESET)
    {
        if((eeI2CInfo.timeout--) == 0)
        {
            errSta = I2C_EE_TIMEOUT;
    ...
    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, (uint8_t)(*number), I2C_RELOAD_MODE_AUTOEND, I2C_GENERATE_NO_STARTSTOP);
    ...
    while(temp != (*number))
    {
        ...
        I2C_TxData(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), (uint8_t)(buffer[temp]));
        temp++;
    }
    
    eeI2CInfo.timeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
    while(I2C_ReadStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_STOP) == RESET)
    {
        if((eeI2CInfo.timeout--) == 0)
        {
            errSta = I2C_EE_TIMEOUT;
    ...
    I2C_ClearStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_STOP);
...
I2C_EE_ERROR_T I2C_EE_WaitEEStandby(void)
{
    ...
    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, 0, I2C_RELOAD_MODE_AUTOEND, I2C_GENERATE_NO_STARTSTOP);
    
    while(I2C_ReadStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_NACK) != RESET)
    {
        eeI2CInfo.timeout = ((uint32_t)0x1000);
        
         
        I2C_ClearStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_NACK | I2C_FLAG_STOP);
        
         
        I2C_EnableGenerateStart(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)));
...
I2C_EE_ERROR_T I2C_EE_BufferRead(uint8_t* buffer, uint16_t readAddr, uint16_t number)
{
    ...
    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, eeI2CInfo.addrNum, I2C_RELOAD_MODE_SOFTEND, I2C_GENERATE_START_WRITE);
...
#line 458 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_i2c_ee.c"
     
    I2C_TxData(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), (uint8_t)(readAddr & 0x00FF));
    
    eeI2CInfo.timeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
    while(I2C_ReadStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_TXCF) == RESET)
    {
        if((eeI2CInfo.timeout--) == 0)
        {
            errSta = I2C_EE_TIMEOUT;
        ...
        while(pageCnt != 0)
        {
            ...
            if((pageCnt == 1) && (remainNumber == 0))
            {
                if(eeI2CInfo.startFlag != 0)
                {
                    ...
                    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, 255, I2C_RELOAD_MODE_AUTOEND, I2C_GENERATE_START_READ);
                }
                else
                {
                     
                    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, 255, I2C_RELOAD_MODE_AUTOEND, I2C_GENERATE_NO_STARTSTOP);
                }
            }
            else
            {
                if(eeI2CInfo.startFlag != 0)
                {
                    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, 255, I2C_RELOAD_MODE_RELOAD, I2C_GENERATE_START_READ);
                }
                else
                {
                    I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, 255, I2C_RELOAD_MODE_RELOAD, I2C_GENERATE_NO_STARTSTOP);
                }
            }
            ...
            {
                eeI2CInfo.timeout = ((uint32_t)(10 * ((uint32_t)0x1000)));
                while(I2C_ReadStatusFlag(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), I2C_FLAG_RXBNE) == RESET)
                {
                    if((eeI2CInfo.timeout--) == 0)
                    {
                        errSta = I2C_EE_TIMEOUT;
                ...
                buffer[temp] = I2C_RxData(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)));
    ...
    {
        I2C_HandlingTransfer(((I2C_T*) (((uint32_t)0x40000000) + 0x00005800)), eeI2CInfo.address, (uint32_t)remainNumber, I2C_RELOAD_MODE_AUTOEND, I2C_GENERATE_START_READ);
