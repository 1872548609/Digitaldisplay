#line 1 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_delay.c"
...
#line 63 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\inc\\bsp_delay.h"
...
#line 28 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_delay.c"
#line 29 "..\\..\\..\\..\\..\\Boards\\Board_APM32F051_EVAL\\src\\bsp_delay.c"
...
void APM_EVAL_DelayInit(void)
{
    SysTick_ConfigCLKSource(((uint32_t)0xFFFFFFFB));
...
void APM_EVAL_DelayMs(volatile uint32_t nms)
{
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (uint32_t)nms * cntMs;
...
void APM_EVAL_DelayUs(volatile uint32_t nus)
{
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (uint32_t)nus * cntUs;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0x00;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= (1UL << 0);
    do
    {
