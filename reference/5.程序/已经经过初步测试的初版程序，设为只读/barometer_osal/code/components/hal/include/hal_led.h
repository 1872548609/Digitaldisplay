...
#define HAL_LED_1                                                   0x01  // 二进制: 00000001 (bit 0)
#define HAL_LED_2                                                   0x02  // 二进制: 00000010 (bit 1)
#define HAL_LED_3                                                   0x04  // 二进制: 00000100 (bit 2)
#define HAL_LED_4                                                   0x08  // 二进制: 00001000 (bit 3)
#define HAL_LED_5                                                   0x10  // 二进制: 00010000 (bit 4)
#define HAL_LED_6                                                   0x20  // 二进制: 00100000 (bit 5)
#define HAL_LED_7                                                   0x30  // 二进制: 01000000 (bit 6)
#define HAL_LED_8                                                   0x40  // 二进制: 10000000 (bit 7)
...
/* Defaults */
#define HAL_LED_DEFAULT_MAX_LEDS                                    8       // 默认支持 8 个 LED
