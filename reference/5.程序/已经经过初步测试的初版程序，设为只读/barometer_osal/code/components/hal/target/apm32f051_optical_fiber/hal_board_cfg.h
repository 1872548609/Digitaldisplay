...
//#define HAL_LED1_TURN_OFF()                                         st(GPIO_SetBit(HAL_LED1_PORT, HAL_LED1_PIN);)
//#define HAL_LED1_TURN_ON()                                          st(GPIO_ClearBit(HAL_LED1_PORT, HAL_LED1_PIN);)
...
//#define HAL_LED2_TURN_OFF()                                         st(GPIO_SetBit(HAL_LED2_PORT, HAL_LED2_PIN);)
//#define HAL_LED2_TURN_ON()                                          st(GPIO_ClearBit(HAL_LED2_PORT, HAL_LED2_PIN);)
...
//#define HAL_LED3_TURN_OFF()                                         st(GPIO_SetBit(HAL_LED3_PORT, HAL_LED3_PIN);)
//#define HAL_LED3_TURN_ON()                                          st(GPIO_ClearBit(HAL_LED3_PORT, HAL_LED3_PIN);)
