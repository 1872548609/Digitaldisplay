...
void DIV_Disp_Uint16Num(uint8_t screen,uint16_t num)
{
	...
	{
		 temp=num/1000%10;
			if(temp==0){DIV_Disp_Num(NIXIE1,NUMNULL);}
	  else{DIV_Disp_Num(NIXIE1,temp); }
			temp=num/100%10;
			if(temp==0){DIV_Disp_Num(NIXIE2,NUMNULL);}
			 else{DIV_Disp_Num(NIXIE2,temp);}
			temp=num/10%10;
			if(temp==0){DIV_Disp_Num(NIXIE3,NUMNULL);}
	   else{DIV_Disp_Num(NIXIE3,temp); }
			temp=num%10;
				if(temp==0){DIV_Disp_Num(NIXIE3,NUMNULL);}
	  else{ DIV_Disp_Num(NIXIE4,temp);}
	}
...
void DIV_Disp_Alphabet(uint8_t nixie,uint8_t alphabet)
{
	...
	uint8_t data1,data2,data3;
		switch(alphabet)
		{
			...
			case Alphabet_D:{data1 = 0xc;data2 = 0x2;data3 = 0xd;}break;
			case Alphabet_E:{data1 = 0xb;data2 = 0x6;data3 = 0x1;}break;
			case Alphabet_F:{data1 = 0x3;data2 = 0x6;data3 = 0x1;}break;
			case Alphabet_G:{data1 = 0xd;data2 = 0x4;data3 = 0x9;}break;
