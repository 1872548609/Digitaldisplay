...
void OutPutContrl(void)
{
		switch(compsestatus1)   //在run模式下按下mode显示不同的设置选项
		{
					case compare1_EASY:{
						    if(unitchange_pressure_value>(P1_Value+diflevel_value))//大于应差才输出
			                 ...
			                 out2_state=0;
										...
										case compare2_WCMP:{
														  if(unitchange_pressure_value>(Lo2_Value+diflevel_value))
															{
																			out2_state=1;
			                 ...
			                 out2_state=0;
															...
															else if(unitchange_pressure_value>(Hi2_Value+diflevel_value))
															{
			                 out2_state=0;
					...
					case compare1_WCMP:{
						   if(unitchange_pressure_value>(Lo1_Value+diflevel_value))
															{
																			out1_state=1;
			                 ...
			                 out1_state=0;
															...
															else if(unitchange_pressure_value>(Hi1_Value+diflevel_value))
															{
			                 out1_state=0;
