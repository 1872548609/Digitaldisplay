/*****************************************************************************
 *   gpio.h:  Header file for NXP LPC11xx Family Microprocessors
 *
...
/*
static __INLINE uint8 GPIOGetValue( uint32_t portNum, uint32_t bitPosi, uint32_t bitVal )
{
	LPC_GPIO[portNum]->DATA = (bitVal<<bitPosi);
}*/
