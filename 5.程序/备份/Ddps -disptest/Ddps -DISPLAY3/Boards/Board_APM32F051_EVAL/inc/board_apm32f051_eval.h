...
#ifndef __BOARD_APM32F051_EVAL_H
#define __BOARD_APM32F051_EVAL_H
...
#define LED4_GPIO_CLK                    RCM_AHB_PERIPH_GPIOC
...
#define KEY2_BUTTON_GPIO_CLK              RCM_AHB_PERIPH_GPIOB

/**
 * @brief Key3 push-button
 */
#define KEY3_BUTTON_PIN                   GPIO_PIN_8
#define KEY3_BUTTON_GPIO_PORT             GPIOB
#define KEY3_BUTTON_GPIO_CLK              RCM_AHB_PERIPH_GPIOB

/**
 * @brief Key4 push-button
 */
#define KEY4_BUTTON_PIN                   GPIO_PIN_9
#define KEY4_BUTTON_GPIO_PORT             GPIOB
#define KEY4_BUTTON_GPIO_CLK              RCM_AHB_PERIPH_GPIOB
